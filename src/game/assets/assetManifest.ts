...
export const GAME_ASSET_MANIFEST = {
  characters: [
    ...
    },
    {
      ...
      placeholder: true,
      purpose: 'preload',
      description: 'Chapter NPC placeholder atlas (forest elder, barista, traveler, guide, glass master, inner voice).',
    ...
    },
    {
      ...
      placeholder: true,
      purpose: 'preload',
      description: 'Chapter boss placeholder atlas (giant can, time monster, snow spirit, glass master, inner doubt, perfectionism).',
